		        ...
		        <div class="inner">
	       		...
	       		<div class="btn">
		       		<span class="btn_b" style="float:right;">
						<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/selectArticleList.do' />?bbsId=${boardMasterVO.bbsId}&lang=en"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a>
						<c:if test="${user.id == 'webmaster'}">
						<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/updateArticleView.do' />?nttId=${result.nttId}&bbsId=${boardMasterVO.bbsId}&lang=en"  title="<spring:message code="button.update" />  <spring:message code="input.button" />"><spring:message code="button.update" /></a>
