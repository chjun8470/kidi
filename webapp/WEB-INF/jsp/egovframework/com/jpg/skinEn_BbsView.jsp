	                ...
	                <div class="inner">
	                    <div class="vw_head">
	                        <ul class="top">
	                            ...
	                            <li class="views txtGray2 marfi2t jana_jcs02 carry_nomargs">HIT <c:out value='${result.inqireCo}'/></li>
	                        </ul>
	                        <ul class="bt vlxnl_4">
	                            ...
	                            <li class="user_name file_fxeto">WRITER<span class="txtPink"><c:out value='${result.frstRegisterNm}'/></span></li>
	                        </ul>
	                    </div>
	                    <!--end vw_head-->
	                    ...
	                    <div class="btn_area4">
	                        <div>
	                            ...
	                            -->
	                            <c:if test="${user.id == 'webmaster' || (user.id == result.ntcrId && boardMasterVO.bbsId == 'BBSMSTR_000000000094')}">
	                            <form id="formDelete" name="formDelete" action="" method="post" style="float:right; margin:0 0 0 3px;">
									<input type="button" class="s_submit" id="uptBtn" value="MODIFY" title="수정 버튼" style="width: 100px;height: 30px;line-height: 28px;text-align: center;border: 1px solid #999;color: #666;font-size: 15px;transition: all .2s;">
									<input type="button" class="s_submit" id="dltBtn" value="DELETE" title="삭제 버튼" style="width: 100px;height: 30px;line-height: 28px;text-align: center;border: 1px solid #999;color: #666;font-size: 15px;transition: all .2s;">
									<input name="nttId" type="hidden" value="<c:out value='${result.nttId}'/>">
									<input name="bbsId" type="hidden" value="<c:out value='${result.bbsId}'/>">
									<input name="lang" type="hidden" value="<c:out value='${lang}'/>">
								</form>
								</c:if>
	                        </div>
	                        <div class="list">
	                        	<c:choose>
									...
									<c:otherwise>
										<a href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${result.bbsId }'/>&lang=en">LIST</a>
									</c:otherwise>
								</c:choose>
	                        </div>
	                    </div>
