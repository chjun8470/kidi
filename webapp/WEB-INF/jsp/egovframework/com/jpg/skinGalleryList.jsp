	        ...
	        <div class="con01">
	            <div class="inner">
	                ...
	                <div class="gallery" style="position: relative;">
	                    ...
	                    <div class="gall_list">
	                        <div class="slider-navddddd" style="position: relative;">
	 							<c:forEach var="resultInfo" items="${resultList}" varStatus="status">
	 								<div class="sliderxxxx"><img src="/cmm/fms/getImage.do?atchFileId=${resultInfo.atchFileId}" alt="${resultInfo.nttCn}">
	                            	</div>
	 							</c:forEach>
	                        </div>
	                    </div>
