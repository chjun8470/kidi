		...
		<div class="contentWrap">
					...
					<div class="ntc_table">
						...
						<table>
							...
							<tr style="line-height: 58px; border-bottom: 1px solid #333;">
								...
								<th style="width: 5%; visibility: visible;" class="disap_68">파일</th>
							...
							<c:forEach items="${resultList}" var="resultInfo"
								...
								<tr>
									...
									<c:choose>
										...
										<c:otherwise>
											<c:choose>
												<c:when test="${resultInfo.secretAt == 'Y' && user.id != resultInfo.ntcrId && user.id != 'webmaster'}">
													<td>비밀글입니다.</td>
												</c:when>
												<c:otherwise>
													<td class="articleSub"
			...
			<div class="btn">
				...
				<form id="writeForm" name="writeForm" method="post"
					...
					<c:choose>
						<c:when test="${user.id == boardMasterVO.bbsAdmin}">
							<input type="button" class="s_submit" id="writeBtn" value="글쓰기" title="글쓰기 버튼1" />
						</c:when>
						<c:otherwise>
