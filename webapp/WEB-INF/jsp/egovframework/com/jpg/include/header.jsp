            ...
            <div class="inner">
                ...
                <div class="hd_menu pc_view">
                    <ul class="hd_ul01">
                        ...
                        <li class="hd_li01">
                            <a href="/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000081" class="hd_a01">발간자료</a>
                            <ul class="hd_ul02">
                                <li class="hd_li02">
                                ...
                                <li class="hd_li02">
                                    <a href="/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000083" class="hd_a02">단행물</a>
                                </li>
								<li class="hd_li02">
