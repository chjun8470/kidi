...
<div id="subWrap" class="sub02">
    ...
    <div id="container">
        ...
        <div class="page_title">WRITE</div>
                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left">
                                        <input id="nttSj" name="nttSj" title="제목 입력" type="text" value="" size="70" maxlength="70" required>
                                    </td>
                                </tr>
<!--                                 <tr class="text">
                                ...
                                <c:choose>
		                   			...
		                   			<tr>
	                                    ...
	                                    <td class="left">
											<input id="nttCn" name="nttCn" title="제목 입력" type="text" value="<c:out value='${articleVO.nttCn}'/>" required>
	                                    </td>        
	                                    </tr>              
		                   			</c:when>
		                   			<c:otherwise>
		                   			<tr class="text">
	                                    ...
	                                    <td class="nopd" colspan="3">
	                                        <textarea class="ckeditor txaClass2" id="nttCn" name="nttCn" rows="20" cols="300" placeholder="내용을 입력하세요." required>
                                ...
                                <tr>
                                    <th><label for="noticeAt">Notice</label></th>
                                ...
                                <tr>
                                    <th><label for="secretAt">Secret</label></th>
                                    <td class="left" colspan="3">
                                ...
                                <tr>
                                    <th><label for="file_1">Add Attach files</label> </th>
                                    <td class="nopd" colspan="3">
                        ...
                        <div class="wj_btn">
                            <ul>
                            	<li><a class="btn_s" href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${boardMasterVO.bbsId }'/>&lang=en" title="목록  버튼">List</a></li>
                            	<li><input type="submit" class="s_submit" value="Write" title="등록 버튼"></li>
                            </ul>
                        </div>
                    </div>
                </form>
