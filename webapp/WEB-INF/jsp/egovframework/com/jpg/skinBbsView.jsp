...
<%
//관리자권한 체크
Boolean loginChk = egovframework.com.cmm.util.EgovUserDetailsHelper.isAuthenticated();
	                ...
	                <div class="inner">
	                    ...
	                    <div class="btn_area4">
	                        <div>
	                            ...
	                            -->
	                            <c:if test="${user.id == 'webmaster' || (user.id == result.ntcrId && boardMasterVO.bbsId == 'BBSMSTR_000000000094') || user.id == boardMasterVO.bbsAdmin}">
	                    ...
	                    <c:if test="${boardMasterVO.bbsId == 'BBSMSTR_000000000094'}">
