...
<%--                 <form method="post" class="schForm">
        ...
        <div class="page_title">MODIFY</div>
            ...
            <div class="inner">
                <form id="articleVO" action="/cop/bbs/updateArticle.do" method="post" onsubmit="fn_egov_regist_article(); return false;" enctype="multipart/form-data">
                    <div class="wTableFrm">
                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left">
                                        <input id="nttSj" name="nttSj" title="제목 입력" type="text" value="${articleVO.nttSj }" size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr>
                                    <th><label for="nttCn">Content <span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="nttCn" name="nttCn" title="공연명 입력" type="text" value="${articleVO.nttCn }"" size="70" maxlength="70">
                                    </td>
                                </tr>
                             	<!-- tr>
									<th><label for="ntceBgnde">날짜 </label></th>
									<td class="left" colspan="3">
										<input id="ntceBgnde" name="ntceBgnde" title="시작날짜" size="70" maxlength="70"  style="width:70px;" value="${articleVO.ntceBgnde }" readonly="true" />
										&nbsp;~&nbsp;<input id="ntceEndde" name="ntceEndde" title="끝날짜" size="70" maxlength="70" style="width:70px;" value="${articleVO.ntceEndde }" readonly="true" />
									</td>
								</tr-->
                                <c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
									...
									<tr>
										<th><label for="file_1">Add File</label> </th>
										<td class="nopd" colspan="3">
                        ...
                        <div class="btn">
                            <input type="submit" class="s_submit" value="Write" title="등록 버튼" onClick="fn_egov_regist_article(); return false;">
                            <a class="btn_s" href="/cop/bbs/selectArticleList.do?bbsId=<c:out value='${boardMasterVO.bbsId }'/>&lang=en" title="목록  버튼">List</a>
                        </div>
                    </div>
                </form>
            </div>
