...
<div style="width: 1000px; margin: 50px auto 50px;">
	...
	<div style="border: 0px solid #666; padding: 20px;">
		<!-- 404 -->
		<p style="color:red; margin-bottom: 8px; ">501 Error</p>

		<div class="boxType1" style="width: 500px;">
			<div class="box">
				<div class="error">
					<p class="title">HTTP 501 Error</p>
					<p class="cont mb20">요청을 수행할 수 있는 기능을 서버가 지원하지 않습니다.<br /></p>
